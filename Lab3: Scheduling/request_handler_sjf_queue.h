#ifndef REQUEST_HANDLER_SJF_QUEUE_H
#define REQUEST_HANDLER_SJF_QUEUE_H
...
class RequestHandlerSjfQueue : public RequestHandler
{
private:
    //TODO fill in
...
public:
    RequestHandlerSjfQueue(Json::Value& config);
    virtual ~RequestHandlerSjfQueue();
...
#endif /* REQUEST_HANDLER_SJF_QUEUE_H */
